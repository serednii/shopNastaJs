...
body.addEventListener('click', (e) => {
    ...
    if (targetElement.closest('.data-click-card')) {//клік на іконці улюблених товарів та  кнопці  товарів корзини
        ...
        // cardList(targetElement, '.cart_list__likes');
    }
    // else if (targetElement.hasAttribute('data-cart')) {//клік на іконці  товарів корзини
    //     cardList(targetElement, '.cart_list__cart');
    // }
    // else if (targetElement.closest('.data-cart')) {//клік на іконці  товарів корзини
    //     cardList(targetElement.closest('.data-cart'), '.cart_list__cart');
    // }
